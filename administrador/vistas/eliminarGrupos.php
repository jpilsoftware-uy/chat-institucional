...
<head>
  ...
  <title>Eliminar Grupos | Administrador</title>
</head>
<body>
                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        <p class="text-center h1 mb-5 mx-1 mx-md-4 mt-4" style="background: linear-gradient(to right, #009ffd, #2a2a72);-webkit-background-clip: text; -webkit-text-fill-color: transparent;">Eliminar Grupos</p>
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            <button type="button" data-toggle="modal" data-target="#modalEliminar" class="btn btn-md mr-3 btn-block" style=" border-radius: 25px; background-image: linear-gradient(to right,#ff0000, #990000); border: 0px; color: #fff; font-weight: bold;">Eliminar Grupo</button>
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                        <img class="img-fluid" src="https://i.ibb.co/1vDRKRC/eliminar-usuario.png" alt="Sample Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title col-11 text-center" style="font-weight: bold;" id="exampleModalLabel">Eliminar Grupo</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <p>Esta a punto de eliminar un grupo del sistema, esta seguro de que desea hacerlo?</p>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="submit" formaction="/borrarGrupo" class="btn text-center" style=" border-radius: 25px; background-image: linear-gradient(to right,#ff0000, #990000); border: 0px; color: #fff;">Eliminar Grupo</button>
                        </div>
                    </div>
                </div>
            </div>
