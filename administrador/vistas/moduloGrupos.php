...
<head>
    ...
    <title>Modulo Grupo | Administrador </title>
    <style>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-deck-wrapper">
                            <div class="card-deck">
                                ...
                                <div class="card mt-4 mb-4 text-center">
                                    <div class="card-header" style="background: linear-gradient(to right, #009ffd, #2a2a72); color: white; font-weight: bold; text-align: center;"> Eliminar Grupos </div>
                                        <div class="card-body">
                                            <p class="card-text"> En esta seccion se puede eliminar a los grupos del sistema. </p>
                                            <a href="/eliminarGrupos" class="btn" style=" border-radius: 25px; background-image: linear-gradient(to right,#009ffd, #2a2a72); border: 0px; color: #fff; font-weight: bold;">Eliminar Grupos</a>
                                            <p class="card-text mt-1">
