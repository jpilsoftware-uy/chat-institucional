                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        <p class="text-center h1 mb-5 mx-1 mx-md-4 mt-4" style="background: linear-gradient(to right, #009ffd, #2a2a72);-webkit-background-clip: text; -webkit-text-fill-color: transparent;">Eliminar Orientaciones</p>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title col-11 text-center" style="font-weight: bold;" id="exampleModalLabel">Eliminar Orientacion</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <p>Esta a punto de eliminar una orientacion del sistema, esta seguro de que desea hacerlo?</p>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="submit" formaction="/eliminarOrientacion" class="btn text-center" style=" border-radius: 25px; background-image: linear-gradient(to right,#ff0000, #990000); border: 0px; color: #fff;">Eliminar Orientacion</button>
                        </div>
                    </div>
                </div>
            </div>
