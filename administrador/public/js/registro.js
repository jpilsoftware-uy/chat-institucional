function validarFormulario(){
    ...
    if( (comprobarCedula() && comprobarTexto(nombre, "nombre") && comprobarTexto(primerApellido, "primer apellido") && comprobarTexto(segundoApellido, "segundo apellido") && comprobarUsuario(usuario)) == true){
        return true;
    } else {
        return false;
    }
